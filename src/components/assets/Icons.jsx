...
export const searchSvgInactive = () => {
  return (
    <svg
      aria-label="Explore"
      color="rgb(38, 38, 38)"
...
export const exploreSvgInactive = () => {
  return (
    <svg
      aria-label="Explore"
      color="rgb(0, 0, 0)"
...
export const createInactiveSvg = () => {
  return (
    <svg
      aria-label="New post"
      class="_ab6-"
...
export const passwordSecuritySvg = () => {
  return (
    <svg
      aria-label=""
      class="x1lliihq x1n2onr6"
...
export const announcementSvg = () => {
  return (
    ...
    >
      <title>
        Ad activity: see which ads you've
